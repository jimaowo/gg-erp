...
<script>
	...
	export default {
		...
		methods: {
			...
			ggSubmit() {
				var apiUrl = "base/produce/companies"
				var method = "POST"
				if(this.itemID) {
					apiUrl = "base/produce/companies/"+ this.itemID
					method = "PUT"
				}
				api.request({
					url: apiUrl,
			...
			//删除
			ggDelete(id) {
				var deleteUrl = 'base/produce/companies/' + id
