...
<script>
	...
	export default {
		...
		methods: {
			...
			ggSubmit() {
				var apiUrl = "base/design/companies"
				var method = "POST"
				if(this.itemID) {
					apiUrl = "base/design/companies/"+ this.itemID
					method = "PUT"
				}
				api.request({
					url: apiUrl,
			...
			//删除
			ggDelete(id) {
				var deleteUrl = 'base/design/companies/' + id
