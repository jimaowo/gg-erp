...
<script>
	...
	export default {
		...
		methods: {
			...
			ggSubmit() {
				var apiUrl = "base/association/types"
				var method = "POST"
				if(this.itemID) {
					apiUrl = "base/association/types/"+ this.itemID
					method = "PUT"
				}
				api.request({
					url: apiUrl,
			...
			//删除
			ggDelete(id) {
				var deleteUrl = 'base/association/types/' + id
