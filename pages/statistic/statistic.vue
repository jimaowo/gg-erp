<template>
	<view class="content">
		<cu-custom bgColor="xg-nav" :isDrawer="true"><block slot="content">统计</block></cu-custom>
		
		<view>
			<view class="example">
				<view class="example-title" v-if="gridData[1]!=undefined">设计相关</view>
				<uni-grid :options="gridData[1]" @click="gridOne" :show-out-border="false" />
				<view class="example-title" v-if="gridData[2]!=undefined">生产相关</view>
	...
	export default {
		...
		data() {
			return {
				...
				swiperGridWidth: '100%',
				gridData: uni.getStorageSync('menu')[4]
			}
		},
		onLoad() {
