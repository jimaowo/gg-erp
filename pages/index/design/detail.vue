<template>
	<view>
		<cu-custom bgColor="xg-nav" :isBack="true">
			...
			<block slot="content">设计单详情</block>
		</cu-custom>
		...
		<form>
			...
			<view class="cu-form-group">
				...
				<input disabled="true" :value="params['year_name']"></input>
				
			</view>
			<view class="cu-form-group">
				<view class="title">设计单位</view>
				<input disabled="true" :value="params['design_company_name']"></input>
				
			</view>
			<view class="cu-form-group">
				<view class="title">款式类别</view>
				<input disabled="true" :value="params['style_type_name']"></input>
			...
			<view class="cu-form-group">
				...
				<input disabled="true" :value="params['process_names']"></input>
			...
			<view class="cu-form-group">
				...
				<input disabled="true" :value="params['cutting_bed_date']"></input>
			</view>
			<view class="cu-form-group">
				<view class="title">完成日期</view>
				<input disabled="true" :value="params['finish_date']"></input>
			</view>
			<view class="cu-form-group">
